...
public class DoctorResponse implements Serializable {
	...
	public com.schooltriangle.mylibrary.model.Status Status;
	 ...
	 * @return the status
	 */
	public com.schooltriangle.mylibrary.model.Status getStatus() {
		return Status;
	}
	 ...
	 *            the status to set
	 */
	public void setStatus(com.schooltriangle.mylibrary.model.Status status) {
		Status = status;
	}
