...
import com.schooltriangle.mylibrary.service.interfaces.AddExternalUser;
import com.schooltriangle.mylibrary.service.interfaces.ConsumerIds;
import com.schooltriangle.mylibrary.service.interfaces.ExternalMemberShipAuthenticate;
...
/*    public  void publishFeedDialog(final Activity current, final String title,
    ...
    public void onClick(final View v) {
       ...
       /* if (viewElementId == R.id.btn_facebook_login) {

            //isFbLogin = true;
            final List<String> permissions = new ArrayList<String>();
            permissions.add("email");
            // start Facebook Login
            Session.openActiveSession(SignUpLoginActivity.this, true,
                                            ...
                                            public void onCompleted(
                                                ...
                                                if (user != null) {
                                                    ...
                                                    social_name = user
                                                            ...
                                                            + " "
                                                            + user.getLastName();
                                                    social_email = (String) user
                                                            .getProperty("email");
                                                    publishFeedDialog(SignUpLoginActivity.this);

                                                    //  publishFeedDialog(SignUpLoginActivity.this);
                                                    addObject = new AddExternalUserRequest(
                                                            user.getFirstName(),
                                                            user.getLastName(),
                                                            social_email,
                                                            "true", social_id,
        ...
        if (viewElementId == R.id.btn_google_login) {
