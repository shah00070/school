package com.schooltriangle.library.main;
...
import com.schooltriangle.library.apiInterfaces.ActivityListner;
import com.schooltriangle.library.apiInterfaces.GetMemberInformation;
import com.schooltriangle.library.apiInterfaces.MemberShipSignup;
import com.schooltriangle.library.apiInterfaces.SendSetPasswordRequest;
import com.schooltriangle.library.events.EventData;
...
import com.schooltriangle.mylibrary.dialog.PhoneEmailExistsWarningDialog;
...
import com.schooltriangle.mylibrary.pojo.ConsumerProfiles;
...
import com.schooltriangle.mylibrary.service.interfaces.ConsumerIds;
        ...
        if (user_email_phone_value.getText().toString().length() > 0) {
            ...
            try {
                ...
                if (CommonCode.validatePhone(emailOrPhoneValue)) {
                    ...
                    Crouton.makeText(ConsumerProfessionalSignup.this,
                            JeevOMUtil.VALID_PHONE, Style.ALERT).show();
                    return;
                }
...
//        }
    ...
    public void openHomeScreen() {
        try {
            Intent myIntent = new Intent(this, Class.forName("com.schooltriangle.main.HomeActivity"));
