...
public class RecentTransactionHistory {
    ...
    public com.schooltriangle.pojos.PackageDetails getPackageDetails() {
        return PackageDetails;
    }

    public void setPackageDetails(com.schooltriangle.pojos.PackageDetails packageDetails) {
        PackageDetails = packageDetails;
    }

    public com.schooltriangle.pojos.PromotionDetails getPromotionDetails() {
        return PromotionDetails;
    }

    public void setPromotionDetails(com.schooltriangle.pojos.PromotionDetails promotionDetails) {
