...
public class TwoFragment extends Fragment {
    ...
    private void initializeData() {
        ...
        HomeActivity.taskk.add(new task("Summer holiday project", "Make a science project with working model to be submitted after summer holidays.", "21:20", "1/7/2016", R.color.transparentt, "Delivered", "Arun Sharma"));
