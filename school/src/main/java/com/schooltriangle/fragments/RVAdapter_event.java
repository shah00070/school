...
public class RVAdapter_event extends RecyclerView.Adapter<RVAdapter_event.PersonViewHolder> {
    ...
    public static class PersonViewHolder  extends RecyclerView.ViewHolder{
        ...
        PersonViewHolder(View itemView) {
            ...
            linear=(LinearLayout)itemView.findViewById(R.id.linearr);
           ...
           // line43=(View)itemView.findViewById(R.id.line43);
            ...
            person_nafme = (TextView)itemView.findViewById(R.id.person_nafmee);
          ...
          //  comment=(EditText)itemView.findViewById(R.id.commentt);
            stasr = (TextView)itemView.findViewById(R.id.stasrr);
            bogokmar = (TextView)itemView.findViewById(R.id.bogokmarr);
...
*/
            ...
            //    personViewHolder.comment_t.setVisibility(View.VISIBLE);
             ...
             /*   ViewGroup.LayoutParams params = personViewHolder.commentone.getLayoutParams();
                ...
                params.height = personViewHolder.comment.getLineCount() * 25;
                personViewHolder.commentone.requestLayout();*/


            //    personViewHolder.linear.setVisibility(View.VISIBLE);


             ///   personViewHolder.comment.setVisibility(View.VISIBLE);
