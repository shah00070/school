package com.schooltriangle.adapters;
...
import com.schooltriangle.pojos.JeevLinkedResult;
import com.schooltriangle.pojos.JeevSearchResult;
import com.schooltriangle.search.JeevSearchFragment;
        ...
        holder.imageView_instant_apoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (session.getLoggedInStatus()) {
                    ...
                    fragment.getActivity().overridePendingTransition(com.schooltriangle.mylibrary.R.anim.trans_left_in, com.schooltriangle.mylibrary.R.anim.trans_left_exit);
                }
            }
        });
