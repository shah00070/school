...
//        HomeActivity.length.add(new Length(50));
        ...
        HomeActivity.persons.add(new Person("Summer Holidays:", "School will be closed from 30th April,2016 till 1st July,2016 in lieu of summer holidays.", "21:20", "30/4/2016", R.color.transparentt, "Self Note"));
